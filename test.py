...
parser.add_argument('--test_set', default ='dataset/test')
parser.add_argument('--real', default ='test/real')
parser.add_argument('--fake', default ='test/fake')
...
if __name__ == '__main__':
    ...
    lstm.load_state_dict(torch.load(os.path.join(opt.outf,'lstm_' + str(100) + '.pt')))
    lstm.eval()
